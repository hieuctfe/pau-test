...
function () {
  ...
  control_createClass(Control, [{
    ...
    value: function setValue(value) {
      this.dotsValue = Array.isArray(value) ? _toConsumableArray(value) : [value];
      this.syncDotsPos();
    ...
    value: function getValues() {
      ...
      if (this.data) {
        ...
        return Array.from(new Array(this.total), function (_, index) {
          return new Decimal(index).multiply(_this5.interval).plus(_this5.min).toNumber();
        }).concat([this.max]);
      }
    }
  }, {
  ...
  vue_slider_createClass(VueSlider, [{
    ...
    value: function render() {
      ...
      return h("div", {
        ...
        return _this6.renderSlot('mark', mark, h("vue-slider-mark", {
          ...
          "style": (_style = {}, vue_slider_defineProperty(_style, _this6.isHorizontal ? 'height' : 'width', '100%'), vue_slider_defineProperty(_style, _this6.isHorizontal ? 'width' : 'height', "".concat(_this6.tailSize, "px")), vue_slider_defineProperty(_style, _this6.mainDirection, "".concat(mark.pos, "%")), _style),
          "on": {
    ...
    get: function get() {
      ...
      return this.control.processArray.map(function (_ref4) {
        ...
        return vue_slider_objectSpread((_objectSpread2 = {}, vue_slider_defineProperty(_objectSpread2, _this7.isHorizontal ? 'height' : 'width', '100%'), vue_slider_defineProperty(_objectSpread2, _this7.isHorizontal ? 'top' : 'left', 0), vue_slider_defineProperty(_objectSpread2, _this7.mainDirection, "".concat(start, "%")), vue_slider_defineProperty(_objectSpread2, sizeStyleKey, "".concat(end - start, "%")), vue_slider_defineProperty(_objectSpread2, "transitionProperty", "".concat(sizeStyleKey, ",").concat(_this7.mainDirection)), vue_slider_defineProperty(_objectSpread2, "transitionDuration", "".concat(_this7.animateTime, "s")), _objectSpread2), style);
      });
    }
  }, {
    key: "dotBaseStyle",
    get: function get() {
      ...
      if (this.isHorizontal) {
        ...
        }, vue_slider_defineProperty(_dotPos, this.direction === 'ltr' ? 'marginLeft' : 'marginRight', "-".concat(dotWidth / 2, "px")), vue_slider_defineProperty(_dotPos, "top", '0'), vue_slider_defineProperty(_dotPos, this.direction === 'ltr' ? 'left' : 'right', '0'), _dotPos);
      } else {
        var _dotPos2;

        dotPos = (_dotPos2 = {
          marginLeft: "-".concat((dotWidth - this.tailSize) / 2, "px")
        }, vue_slider_defineProperty(_dotPos2, this.direction === 'btt' ? 'marginBottom' : 'marginTop', "-".concat(dotHeight / 2, "px")), vue_slider_defineProperty(_dotPos2, "left", '0'), vue_slider_defineProperty(_dotPos2, this.direction === 'btt' ? 'bottom' : 'top', '0'), _dotPos2);
      }
